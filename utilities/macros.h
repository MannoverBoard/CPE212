...
#define MACRO_GET_4(first,second,third,fourth,...) fourth
...
#define GET_ENUM_ATTR_HAS_SCOPE(EnumName)  EVAL(DEFER(GET_MACRO_ATTRIBUTES(EnumName))(MACRO_GET_2))
#define GET_ENUM_ATTR_SCOPE(EnumName)      EVAL(DEFER(GET_MACRO_ATTRIBUTES(EnumName))(MACRO_GET_3))
#define GET_ENUM_ATTR_HAS_VALUES(EnumName) EVAL(DEFER(GET_MACRO_ATTRIBUTES(EnumName))(MACRO_GET_4))
#define GET_ENUM_SCOPED_NAME(EnumName) IFF(GET_ENUM_ATTR_HAS_SCOPE(EnumName))(GET_ENUM_ATTR_SCOPE(EnumName)::,EMPTY())EnumName
...
IFF(GET_ENUM_ATTR_HAS_SCOPE(EnumName))( } ,EMPTY()) \
...
bool isValid(const GET_ENUM_SCOPED_NAME(EnumName) value) { \
  switch(value) { \
    GET_MACRO_MEMBERS(EnumName)(ENUM_MACRO_DEFINITIONS__CALLBACK_02,__VA_ARGS__) \
      return true; \
