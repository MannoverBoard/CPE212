...
Goblin::Goblin(const string& characterName, const Race characterRace) :
	Character(characterName, characterRace, static_cast<Action>(&Goblin::SneakAttack))
{
 ...
 */
Character& Goblin::SneakAttack(Character&  target) {
 ...
 */
Character& Goblin::Attack_(Character& target) {
	const auto weapon = GetWeapon();
